...
def test_lido_stake():
    ...
    web3.eth.contract.return_value.functions.submit.return_value.build_transaction.return_value = {
        'from': '0xUserAddress',
...
def test_lido_unstake():
    web3 = MagicMock(spec=Web3)
    web3.toWei = Web3.toWei
    web3.eth.contract.return_value.functions.requestWithdraw.return_value.build_transaction.return_value = {
        'from': '0xUserAddress',
        'gas': 200000,
        'gasPrice': Web3.toWei('5', 'gwei')
    }
